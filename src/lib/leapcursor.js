...
import {LeapTrainer} from './leaptrainer.min.js'
import Detector from './detector.min.js'
...
LeapCursor.prototype = {
	...
	createCursor: function() {
		...
		} else if (this.attachEvent) { window.attachEvent("onResize", this.setDefaultPosition.bind(this)); }
		...
		window.requestAnimFrame(this.updateRender.bind(this));
	 ...
	 */
	updateRender: function () { this.renderer.render(this.scene, this.camera); window.requestAnimFrame(this.updateRender.bind(this)); },
...
} else if (this.attachEvent) { window.attachEvent("onLoad", function() { window.leapCursor = new LeapCursor(params); }); }
