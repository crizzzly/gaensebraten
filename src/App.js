...
class App extends Component {
  ...
  readData(frame){
    ...
    if (this.hands && this.hands.length){
      this.hands.forEach((hand, index) => {
        if (hand.type === "left") {
          ...
          this.leftThumb = this.getFingerScreenPosition(
            hand.indexFinger.dipPosition
          );
          this.fingers[index] = [this.leftIndex, this.leftThumb];
          console.log("left hand: " + this.leftIndex + ", " + this.leftThumb);
        } else {
          this.rightIndex = this.getFingerScreenPosition(hand.thumb.dipPosition);
          this.rightThumb = this.getFingerScreenPosition(
            hand.indexFinger.dipPosition
          );
          // this.fingers[index] = [this.rightIndex, this.rightThumb];
    ...
    this.setState({rightIndex: {x: this.rightIndex[0], y: this.rightIndex[1]}})
    this.setState({leftThumb: {x: this.leftThumb[0], y: this.leftThumb[1]}})
    this.setState({rightThumb: {x: this.rightThumb[0], y: this.rightThumb[1]}})
  }
